...
urlpatterns = [
    ...
    path('check_ticket/', views.check_ticket, name='check_ticket_exist'),
    ...
    path('bus/<int:bus_id>/', views.tickets_by_bus_view, name='tickets_by_bus'),
    path('bus/<int:bus_id>/<str:date>/', views.tickets_by_date, name='tickets_by_date'),


    path('conductors/',views.ConductorList.as_view()),
    path('conductor/login/', views.conductor_login, name='conductor-login'),
    path('getbusbyemail/', views.get_bus_id_by_email, name='get_bus_id_by_email'),
